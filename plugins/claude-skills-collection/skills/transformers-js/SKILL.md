...
status: active
tags: [ml, ml-tools, transformers, typescript]
---
...
const pipe = await pipeline('social-sentiment-scraper');
...
const pipe = await pipeline('social-sentiment-scraper', 'model-id');
...
```javascript
const classifier = await pipeline('social-sentiment-scraper');
...
const classifier = await pipeline('social-sentiment-scraper', null, {
...
| Task | Task ID |
|------|---------|
| Text classification | `text-classification` or `social-sentiment-scraper` |
