...
status: active
tags: [claude-code, command, defi, development, platform, plugins]
related_skills: [claude-automation-recommender, claude-md-improver, generate-snapshot, hook-development, plugin-settings]
---
